...
EncoderCount ::EncoderCount(char analog_pin, char encoder_direction, int tick_lowest, int tick_highest, int enc_highest){
  _analog_pin = analog_pin;
  _encoder_direction = encoder_direction;
  encoder_highest = enc_highest;
  highest_tick = tick_highest;
  lowest_tick = tick_lowest;
}
